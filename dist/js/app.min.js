...
$(document).ready(function(){$("li.has-child").click(function(){$(this).children("ul").slideToggle()})}),document.addEventListener("DOMContentLoaded",function(){const e=document.querySelector(".mobile-menu-burger"),t=document.querySelector(".mobile-menu-container");e.addEventListener("click",function(){t.classList.toggle("active"),e.classList.toggle("active")})});var main=new Swiper(".main-header-slider",{slidesPerView:1,spaceBetween:30,loop:!0,autoplay:{delay:8e3,disableOnInteraction:!1},pagination:{el:".swiper-pagination",clickable:!0}}),swiper=(window.addEventListener("scroll",function(){var e=document.querySelector("header");0<(window.pageYOffset||document.documentElement.scrollTop)?e.classList.add("header-white-bg"):e.classList.remove("header-white-bg")}),new Swiper(".references-slider",{slidesPerView:1,spaceBetween:10,loop:!1,pagination:{el:".references-slider-pagination",clickable:!0},breakpoints:{467:{slidesPerView:1,spaceBetween:10},640:{slidesPerView:11,spaceBetween:10},768:{slidesPerView:1,spaceBetween:10},1024:{slidesPerView:1,spaceBetween:10}}})),swiper=new Swiper(".box-slider",{slidesPerView:4,spaceBetween:10,loop:!1,pagination:{el:".box-slider-pagination",clickable:!0},breakpoints:{100:{slidesPerView:1,spaceBetween:10},467:{slidesPerView:1,spaceBetween:10},640:{slidesPerView:1,spaceBetween:10},768:{slidesPerView:2,spaceBetween:10},1024:{slidesPerView:4,spaceBetween:10}}}),swiper=new Swiper(".team-slider",{slidesPerView:4,spaceBetween:10,loop:!1,pagination:{el:".team-slider-pagination",clickable:!0},breakpoints:{100:{slidesPerView:1,spaceBetween:10},467:{slidesPerView:1,spaceBetween:10},640:{slidesPerView:1,spaceBetween:10},768:{slidesPerView:2,spaceBetween:10},1024:{slidesPerView:1,spaceBetween:10}}}),swiper=new Swiper(".comments-slider",{slidesPerView:1,spaceBetween:10,loop:!0,pagination:{el:".comments-slider-pagination",clickable:!0},breakpoints:{100:{slidesPerView:1,spaceBetween:10},467:{slidesPerView:1,spaceBetween:10},640:{slidesPerView:1,spaceBetween:10},768:{slidesPerView:1,spaceBetween:10},1024:{slidesPerView:3,spaceBetween:10}}}),swiper=new Swiper(".before-slider",{slidesPerView:4,spaceBetween:10,loop:!0,pagination:{clickable:!0},navigation:{nextEl:".next",prevEl:".prev"},breakpoints:{100:{slidesPerView:1,spaceBetween:10},467:{slidesPerView:1,spaceBetween:10},640:{slidesPerView:1,spaceBetween:10},768:{slidesPerView:3,spaceBetween:10},1024:{slidesPerView:4,spaceBetween:10}}}),triggers=($(document).ready(function(){$(".faq-question").click(function(){$(".faq-question.active").not(this).removeClass("active").next(".faq-answer").slideUp(),$(this).next(".faq-answer").slideToggle(),$(this).toggleClass("active")})}),document.querySelectorAll(".trigger")),closeButtons=document.querySelectorAll(".close-button");function toggleModal(e){e=e.currentTarget.getAttribute("data-target"),e=document.getElementById(e);e&&e.classList.toggle("show-modal")}function windowOnClick(e){e.target.classList.contains("modal")&&e.target.classList.remove("show-modal")}triggers.forEach(function(e){e.addEventListener("click",toggleModal)}),closeButtons.forEach(function(e){e.addEventListener("click",function(e){console.log("tıklandı");e=e.currentTarget.getAttribute("data-target"),e=document.getElementById(e);e&&e.classList.remove("show-modal")})});var didScroll,modals=document.querySelectorAll(".modal"),lastScrollTop=(modals.forEach(function(e){e.addEventListener("click",windowOnClick)}),$("#main-form").submit(function(e){e.preventDefault();$(this);e=$("#main-form").serialize();$("#name").val()&&$("#email").val()&&$("#phone").val()&&$("#country").val()&&$("#url").val()?$.ajax({type:"POST",url:"https://www.yuzyilhospital.com/landing/obezite/ajax",data:e,beforeSend:function(){$("button").prop("disabled",!0),$("button").html("Please Wait"),console.log("1")},success:function(e){"Message sent!"==e?($("button").prop("disabled",!0),$("button").html("Message sent!"),alert("Message sent successfully."),console.log("2")):($("button").prop("disabled",!1),alert("Message not sent, please try again."),console.log("3"))}}):alert("Lütfen tüm alanları doldurun!")}),$("#contact").submit(function(e){e.preventDefault();$(this);e=$("#contact").serialize();$("#name").val()&&$("#email").val()&&$("#phones").val()&&$("#message").val()&&$("#url").val(),$.ajax({type:"POST",url:"https://www.yuzyilhospital.com/landing/obezite/ajax2",data:e,beforeSend:function(){$("#contact_button").prop("disabled",!0),$("#contact_button").html("Please Wait"),console.log("1")},success:function(e){"Message sent!"==e?($("#contact_button").prop("disabled",!0),$("#contact_button").html("Message sent!"),alert("Message sent successfully."),console.log("2")):($("#contact_button").prop("disabled",!1),alert("Message not sent, please try again."),console.log("3"))}})}),$(window).scroll(function(){100<=$(window).scrollTop()?($(".dark-logo").fadeTo(0,1),$(".light-logo").fadeTo(0,0),$("header").addClass("light-header")):($(".dark-logo").fadeTo(0,0),$(".light-logo").fadeTo(0,1),$("header").removeClass("light-header"))}),0),delta=5,navbarHeight=$("header").outerHeight();function hasScrolled(){var e=$(this).scrollTop();Math.abs(lastScrollTop-e)<=delta||(lastScrollTop<e&&navbarHeight<e?$("header").removeClass("nav-down").addClass("nav-up"):e+$(window).height()<$(document).height()&&$("header").removeClass("nav-up").addClass("nav-down"),lastScrollTop=e)}$(window).scroll(function(e){didScroll=!0}),setInterval(function(){didScroll&&(hasScrolled(),didScroll=!1)},250);